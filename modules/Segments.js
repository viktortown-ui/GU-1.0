...
class Segments {
            ...
            <tr class="border-b hover:bg-gray-50" data-segment-id="${segment.id}">
                ...
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.volume || 0}"
                        min="0"
                        onchange="app.modules.segments.updateSegment(${segment.id}, 'volume', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.frequency || 1}"
                        min="1"
                        max="365"
                        onchange="app.modules.segments.updateSegment(${segment.id}, 'frequency', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.metrics?.accessibility || 3}"
                        min="1"
                        max="5"
                        onchange="app.modules.segments.updateMetric(${segment.id}, 'accessibility', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.metrics?.willingness || 3}"
                        min="1"
                        max="5"
                        onchange="app.modules.segments.updateMetric(${segment.id}, 'willingness', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.metrics?.pain || 3}"
                        min="1"
                        max="5"
                        onchange="app.modules.segments.updateMetric(${segment.id}, 'pain', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
                    <input 
                        ...
                        value="${segment.metrics?.reach || 3}"
                        min="1"
                        max="5"
                        onchange="app.modules.segments.updateMetric(${segment.id}, 'reach', parseInt(this.value))"
                    />
                </td>
                <td class="py-3">
    ...
    updateStats() {
        ...
        if (averageEl && activeSegments.length > 0) {
            const average = Math.round(activeSegments.reduce((sum, s) => sum + s.index, 0) / activeSegments.length);
